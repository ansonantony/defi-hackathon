...
const AddLiquidity = ({ CREATE_LIQUIDITY, setOpenAddPool }) => {
          ...
          <div className="newaddpol mb30">
            <div className="register-form form--dark">
                ...
                <select
                  onChange={(e) => {
                    const selected = poolHistory?.find(
                      (x, index) => index + 1 === parseInt(e.target.value)
                    );
              ...
              <button
                ...
                className="btn btn btn--large btn--green-light btn--with-icon btn--icon-right full-width"
              >
                Check Pool
                <svg className="woox-icon icon-arrow">
...
// const AddLiquidity = ( CREATE_LIQUIDITY,
//   setOpenAllLiquidity) => {
...
//         <div className="register-form form--dark">
//           <header className="
//           crumina-module crumina-heading heading--h2 heading--with-decoration
//           ">
...
//       <button onClick={() => CREATE_LIQUIDITY(selectedPool,liquidityAmount,approveAmount)}
//           className="btn btn btn--large btn--green-light btn--with-icon btn--icon-right full-width"
